...
Future<Response> addSocialMediaHandler(Request req) async {
  try {
    final supabase = SupabaseClass().supabaseGet;

    final body = json.decode(await req.readAsString());
    validatorBody(body: body, keyBody: ['username', 'social']);
    ...
    final data = await supabase.from("social_media").upsert(
